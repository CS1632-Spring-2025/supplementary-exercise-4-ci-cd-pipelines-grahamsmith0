...
public class RentACatIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		InstanceType type = InstanceType.IMPL;
		...
		r = RentACat.createInstance(type);
		...
		c1 = Cat.createInstance(type, 1, "Jennyanydots");
	...
	public void testRentCatFailureNumCats3() {
		...
		assertEquals(out.toString(),
				"Old Deuteronomy has been rented." + newline + "Sorry, Old Deuteronomy is not here!" + newline);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertEquals(out.toString(),
				"Old Deuteronomy has been rented." + newline + "Welcome back, Old Deuteronomy!" + newline);
	}
